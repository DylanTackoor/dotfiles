...
brew install wget
brew install wifi-password # displays connected wifi connection
brew install yarn
...
npm i -G typescript tslint ts-node eslint reload siteaudit
